...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(maximumProfit(prices3));
    }


    //another example of overly complicated problem
    static int maximumProfit(int[] prices) {
        // prices on next day > prices today 😝

        // we are only concerned about the days when i < i+1, i.e to buy as low and sell
        // as high as possible
        int profit = 0;
